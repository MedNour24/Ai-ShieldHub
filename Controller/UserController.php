...
function handleGetNotifications($userModel) {
    ...
    try {
        ...
        // Ajouter les détails des utilisateurs pour les notifications avec user_id
        foreach ($notifications as &$notification) {
            if (isset($notification['user_id']) && !empty($notification['user_id'])) {
                $userDetails = $userModel->getUserById($notification['user_id']);
                if ($userDetails) {
