                  ...
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="#" class="nav-link" data-page="question_manage">
                        <span class="sub-item">Reponse</span>
                      </a>
                    </li>
                  </ul>
                </div>
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div id="tournoi-page" class="page-content">
              <iframe src="tournoi_admin.html" style="width: 100%; height: calc(100vh - 150px); border: none;"></iframe>
            </div>

            <div id="quiz_manage-page" class="page-content">
                <iframe src="../../view/backoffice/quizmanagment_admin.html" class="iframe-container"></iframe>
            </div>

            <div id="question_manage-page" class="page-content">
                <iframe src="../..//view/backoffice/modulequiz_admin.html" class="iframe-container"></iframe>
            </div>
          </div>
        </div>
      </div>
